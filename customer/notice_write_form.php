...
<link type="text/css" rel="stylesheet" href="./css/write_form.css?v=21">
...
if(isset($mode) && $mode === "modify"){
?>
<form name="board_form" action="notice_insert.php?mode=modify&num=<?=$num?>&page=<?=$page?>&table=<?=$table?>" method="post" enctype="multipart/form-data" onsubmit="return false">
<?php 
}else{
?>
<form name="board_form" action="notice_insert.php?table=<?=$table?>&page=<?=$page?>" method="post" enctype="multipart/form-data" onsubmit="return false">
<?php 
}
?>
...
<!-- 내용 -->		
		<div id="content_frame">
			...
			<div id="content_input">
				<textarea rows="33%" cols="95%" name="content" id="content_text"><?=$item_content?></textarea>
			</div> <!-- content_input -->
		</div> <!-- content_frame -->
...
<!-- ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ -->
	...
	<a href="#"><input type="image" src="./img/10.작성.png" id="register" onclick="check_input()"></a>
	<a href="notice.php?table<?=$table?>&page=<?=$page?>"><input type="image" src="./img/7.목록.png" id="list1"></a>
	</div>
      </div>
       </section>
    <?php
